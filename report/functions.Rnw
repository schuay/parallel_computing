...
plotWork <- function(file) {
	...
	texPlot(x,y, pch, txt, "input size", "work", "Work as function of input size", "")
}
...
makeAvgSpeedupTables <- function(file) {
