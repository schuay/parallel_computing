...
% TODO Implement using reduction clause
...
% TODO: Make sure we get the correct Tpar (the process taking the longest),
% suggestion: MPI_Reduce(MPI_MAX), although MPI_Barrier seems to be better?
...
achieve a speed-up of % TODO
for $1000$ stencil iterations performed on a $1000 \times 1000$ matrix.
